...
class UpdateCarComponent extends Component {
    ...
    componentDidMount(){
        ...
        CarService.getCarById(this.state.car_id).then((res)=>{
            let car=res.data;
            this.setState({
                ...
                prenomU:car.user.prenom,
                 prenomC:car.client.prenom,
                nomE:car.entroprise.nom,
                client_id:car.client.client_id,
                user_id:car.user.userId,
                entroprise_id:car.entroprise.entroprise_id
            });
    ...
    updateCar=(h)=>{
        ...
        CarService.updateCar(this.state.user_id,this.state.client_id,this.state.entroprise_id,this.state.car_id,car).then(res=>{
          ...
          <div className="content-wrapper">
            ...
            <div className="card mb-4">
                ...
                <small className="text-muted float-end"> </small>
                                        ...
                                        <h5 className="text-center mt-3"><i className="bi bi-pencil-square"></i> Car Bill</h5>
                ...
                <form>
                    ...
                    <div className="col-sm-10">
                        <button type="submit" onClick={this.updateCar} className="btn btn-outline-success"><i className="bx bx-refresh" /> Update</button>
                    </div>
                    </div>
                </form>
                </div>
