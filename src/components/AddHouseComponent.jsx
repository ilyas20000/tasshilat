...
class addHouseComponent extends Component {
    ...
    saveHouse=(h)=>{
        ...
        HouseService.addHouse(house.user_id,house.client_id,house.entroprise_id,house).then(res=>{
    ...
    capeurImage=()=>{
        console.log("hani")
        let wspDiv=document.getElementById("printId").contentWindow;
        wspDiv.print();
...
<div className="col-xxl">
  <div className="card mb-4">
    ...
    <div className='text-center'>
                            <h5 className="text-center mt-3"><i className="bi bi-plus-lg"></i> House Bill</h5>
    ...
    <div className="card-body mt-4">
      <form>
        ...
        <div className="row justify-content-end">
          <div className="col-sm-10">
            <button type="submit" onClick={this.saveHouse} className="btn btn-outline-success"><i className="bx bx-save" /> Save</button>
          </div>
        </div>
      </form>
    </div>
