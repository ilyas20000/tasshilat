...
class ListFaceurComponent extends Component {
    constructor(props){
        ...
        this.state={
            ...
            entroprise_id:localStorage.getItem("ent_id_bill"),
            
            facteurs:[],
            tablefh:[],
            dataTh:[],
            show_div:false,
            id:localStorage.getItem("ent_id_bill"),
            i:0,
            value:'',
            tableFilter:[],
            serchHouse:"",
      ...
      Swal.fire({
       ...
       this.sendEmail()
        ...
        CarService.updateCarEtat(car_id,car).then(res=>{
          window.history.pushState({}, undefined, `/pCar/${car_id}`);
                  window.history.go();
      })
      },2000)
    }
      ...
      Swal.fire({
        ...
        setTimeout(()=>{ 
          HouseService.updateHouseEtat(house_id,house).then(res=>{
                  ...
                  window.history.pushState({}, undefined, `/p/${house_id}`);
                  window.history.go();
        })
      },2000)
