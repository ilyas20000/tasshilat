  ...
  return (
    <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
      ...
      <ul className="menu-inner py-1">
        ...
        <li className={`menu-item ${open ? "open active" : ""}`} onClick={() => { setOpen(open ? false : true) }}>
        ...
        <li className={`menu-item ${open2 ? "open active" : ""}`} onClick={() => { setOpen2(open2 ? false : true) }}>
          <a className="menu-link menu-toggle">
        ...
        {/* Electricity */}
        <li className={`menu-item ${open5 ? "open active" : ""}`} onClick={() => { setOpen5(open5 ? false : true) }}>
          <a className="menu-link menu-toggle">
        ...
        <li className={`menu-item ${open3 ? "open active" : ""}`} onClick={() => { setOpen3(open3 ? false : true) }} >
        ...
        <li className={`menu-item ${open4 ? "open active" : ""}`} onClick={() => { setOpen4(open4 ? false : true) }} >
          <a href="#" className="menu-link menu-toggle">
        ...
        <li className={`menu-item ${open6 ? "open active" : ""}`} onClick={() => { setOpen6(open6 ? false : true) }} >
          <a href="#" className="menu-link menu-toggle">
