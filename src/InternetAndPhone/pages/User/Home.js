                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          ...
                          <a href='/choise' class="btn btn-outline-primary">Go</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row g-0">
                      <div class="col-md-8">
                        <div class="card-body">
                          ...
                          <a href='/phone-internet' class="btn btn-outline-primary">Go</a>
                        </div>
                      </div>
                      <div class="col-md-4">
                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          ...
                          <a href='/universityService' class="btn btn-outline-primary">Go</a>
                        </div>
                      </div>
                    </div>
                  </div>
